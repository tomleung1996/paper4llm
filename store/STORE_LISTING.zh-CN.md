...
- 支持 ScienceDirect、Wiley Online Library、Nature、SpringerLink、Science / AAAS、MDPI、Taylor & Francis、Frontiers、Oxford Academic、MIT Press Direct、arXiv HTML、IEEE Xplore、Wolters Kluwer/Ovid 与 SAGE 论文页面。
...
- **受支持网站的访问权限：** 仅在上列受支持学术论文网址上读取 DOM，以提取用户主动请求转换的论文内容。
